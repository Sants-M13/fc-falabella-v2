...
## Tasks / Subtasks
- [ ] Task 1: Supabase Development Environment Setup (AC: 1, 2)
  - [ ] Install and configure Supabase CLI
  - [ ] Initialize Supabase project locally (`supabase init`)
  - [ ] Link to remote project (`supabase link --project-ref pbcdbmzrumntbhpispvb`)
  - [ ] Configure Supabase MCP server in Claude Code environment
  - [ ] Test MCP-Supabase connectivity and basic operations
  - [ ] Verify both CLI and MCP can execute database operations
- [ ] Task 2: Project Foundation and Dependencies (AC: 3, 8, 9)
  - [ ] Initialize Next.js 14.x with TypeScript 5.x
  - [ ] Configure monorepo structure per architecture specification
  - [ ] Install all tech stack dependencies (shadcn/ui, TanStack Query, Zustand, etc.)
  - [ ] Set up ESLint and Prettier configurations
- [ ] Task 3: Database Schema and Security Setup (AC: 4)
  - [ ] Create initial database migrations using Supabase CLI
  - [ ] Create profiles table with role and store_id fields via migration
  - [ ] Create stores table with constraints via migration
  - [ ] Implement RLS policies via migration files
  - [ ] Deploy migrations to remote (`supabase db push`)
  - [ ] Generate TypeScript types (`supabase gen types typescript`)
  - [ ] Test RLS policies via MCP operations
- [ ] Task 4: Environment and Configuration Setup (AC: 5, 6)
  - [ ] Validate environment variables configuration (.env.local)
  - [ ] Set up Vercel development environment
  - [ ] Test `vercel dev` workflow functionality
  - [ ] Configure Supabase client library connection
- [ ] Task 5: Authentication Foundation (AC: 7)
  - [ ] Implement Supabase Auth integration
  - [ ] Create basic login/logout components
  - [ ] Set up protected route structure for admin/promotora
  - [ ] Test authentication flow functionality
- [ ] Task 6: Testing Infrastructure (AC: 10)
  - [ ] Configure Vitest for unit testing (install and setup)
  - [ ] Configure Playwright via MCP (MCP Playwright already available)
  - [ ] Create initial test structure and examples
  - [ ] Validate testing frameworks work with MCP-Supabase setup
  - [ ] Create sample E2E test using MCP Playwright integration
